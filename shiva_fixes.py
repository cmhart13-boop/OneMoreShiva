...
.st-key-bottom_nav_shell .stButton>button{height:46px!important;min-height:46px!important;padding:4px 3px!important;border-radius:11px!important;font-size:13px!important;line-height:1!important;overflow:visible!important}
[data-testid="stMainBlockContainer"],.main .block-container,.block-container{padding-bottom:calc(55px + env(safe-area-inset-bottom))!important}
.st-key-primary_nav_Home .stButton>button{position:relative!important;padding-top:23px!important;padding-bottom:4px!important}
.st-key-primary_nav_Home .stButton>button::before{display:block!important;content:""!important;position:absolute!important;top:3px!important;left:50%!important;transform:translateX(-50%)!important;width:18px!important;height:18px!important;background-color:transparent!important;border:0!important;border-radius:0!important;box-shadow:none!important;mix-blend-mode:screen!important;filter:none!important;background-position:center!important;background-size:contain!important;background-repeat:no-repeat!important}
[data-stale="true"],[data-testid="stAppViewContainer"] [data-stale="true"],.stale{opacity:1!important;filter:none!important}
...
div[role="radiogroup"] label[data-baseweb="radio"]:has(input:checked){border-color:rgba(240,216,143,.72)!important;background:linear-gradient(145deg,rgba(213,177,92,.24),rgba(213,177,92,.10))!important;color:#fff!important;box-shadow:0 0 0 1px rgba(213,177,92,.12)!important}

/* GUIDE — readable, Home-sized typography and Home-style cards. */
.guide-toc{gap:10px!important;margin:4px 0 15px!important}
.guide-section-card,.article-card,.player-feature,.strategy-box,.rank-row,.article-body,.rounds{background:var(--sv-panel)!important;border:1px solid var(--sv-line)!important;border-radius:16px!important;box-shadow:none!important}
...
.st-key-guide_rank_filters .stButton>button{min-height:39px!important;border-radius:11px!important;font-size:12px!important;font-weight:950!important;background:#0d161d!important;border-color:#30404b!important;color:#9eabb3!important}
.st-key-guide_rank_filters .stButton>button[kind="primary"]{border-color:rgba(240,216,143,.72)!important;background:linear-gradient(145deg,rgba(213,177,92,.24),rgba(213,177,92,.10))!important;color:#fff!important;box-shadow:0 0 0 1px rgba(213,177,92,.12)!important}
...
.coach-hero{background:linear-gradient(145deg,#111b23,#0d151b)!important;border:1px solid rgba(213,177,92,.30)!important;border-radius:17px!important;padding:16px!important;margin-bottom:13px!important}
...
.coach-player-card,.moment,.watch-card{background:var(--sv-panel)!important;border:1px solid var(--sv-line)!important;border-radius:16px!important;padding:14px!important}
...
.shiva-says-call,.draft-moment,.lineup-alert{background:linear-gradient(145deg,rgba(213,177,92,.12),rgba(213,177,92,.04))!important;border:1px solid rgba(213,177,92,.30)!important;border-radius:16px!important;padding:14px!important}
...
.draft-start-intro{background:linear-gradient(145deg,#111b23,#0d151b)!important;border:1px solid var(--sv-line)!important;border-radius:17px!important;padding:16px!important;margin:7px 0 12px!important}
...
html,body,#root,.stApp,[data-testid="stApp"],[data-testid="stAppViewContainer"],[data-testid="stMain"]{background:var(--sv-bg)!important;background-color:var(--sv-bg)!important;color-scheme:dark!important}
