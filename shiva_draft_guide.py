...
.st-key-guide_tab div[role="radiogroup"] label:has(input:checked)::after{content:"";position:absolute;left:12px;right:12px;bottom:7px;height:2px;border-radius:2px;background:rgba(116,227,210,.55)}
...
@media(max-width:430px){.st-key-guide_tab div[role="radiogroup"]{gap:5px!important}.st-key-guide_tab div[role="radiogroup"] label{min-height:72px!important}.st-key-guide_tab div[role="radiogroup"] [data-testid="stMarkdownContainer"] p{font-size:10px!important}}
</style>'''
