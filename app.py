...
.mini-stat{padding:12px 8px!important;min-height:112px!important;display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important}.mini-stat b{font-size:25px!important;line-height:1!important}.mini-stat span{font-size:11px!important;line-height:1.25!important;letter-spacing:0!important;text-transform:none!important;margin-top:7px!important}
.quick-card{min-height:100px!important;padding:15px!important}.quick-icon{font-size:25px!important}.quick-title{font-size:16px!important;line-height:1.2!important}.quick-sub{font-size:12px!important;line-height:1.35!important}
...
.home-shiva-hero{background:linear-gradient(140deg,#182b3b,#0a1219 68%);border:1px solid #365167;border-radius:19px;padding:17px 16px 15px;margin:3px 0 8px;position:relative;overflow:hidden}.home-shiva-hero:after{content:"✦";position:absolute;right:12px;top:-12px;font-size:94px;color:#ec1738;opacity:.10}.home-shiva-kicker{font-size:11px;font-weight:950;color:#d9ff38;letter-spacing:1px;text-transform:uppercase}.home-shiva-title{font-size:27px;font-weight:980;color:#fff;letter-spacing:-.8px;line-height:1.05;margin-top:5px}.home-shiva-copy{font-size:14px;color:#b6c2cb;line-height:1.4;margin-top:6px;max-width:90%}.home-ask-label{font-size:12px;font-weight:900;color:#c6d2da;margin:2px 0 3px}.work-note{font-size:12px;color:#aebdc7;line-height:1.45}.work-note b{color:#fff}.metric-rb b,.metric-rb span{color:#f0a15e!important}.metric-wr b,.metric-wr span{color:#5da4f2!important}.metric-ppg b,.metric-ppg span{color:#52d68b!important}.metric-weeks b,.metric-weeks span{color:#e5c34b!important}
.quick-card.q-draft{border-color:#3b78a7!important;box-shadow:inset 0 0 0 1px rgba(59,120,167,.12)}.quick-card.q-guide{border-color:#9a5ac9!important;box-shadow:inset 0 0 0 1px rgba(154,90,201,.12)}.quick-card.q-players{border-color:#2c9b82!important;box-shadow:inset 0 0 0 1px rgba(44,155,130,.12)}.quick-card.q-roster{border-color:#b8873d!important;box-shadow:inset 0 0 0 1px rgba(184,135,61,.12)}
@media(max-width:430px){.stat-strip{gap:7px!important}.mini-stat{min-height:122px!important;padding:11px 6px!important}.mini-stat b{font-size:26px!important}.mini-stat span{font-size:11px!important}.st-key-draft_view div[role="radiogroup"]{gap:6px!important}.st-key-draft_view div[role="radiogroup"] label{min-height:84px!important;padding-left:2px!important;padding-right:2px!important}.st-key-draft_view div[role="radiogroup"] [data-testid="stMarkdownContainer"] p{font-size:12px!important}.player-shell.draft-player{grid-template-columns:36px minmax(0,1fr) 37px 37px 58px!important;padding-left:6px!important;padding-right:6px!important}}
'''
