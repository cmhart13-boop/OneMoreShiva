...
st.html(
    ...
    .draft-inline{background:linear-gradient(145deg,rgba(213,177,92,.24),rgba(213,177,92,.10))!important;border-color:rgba(240,216,143,.72)!important;color:#fff!important;box-shadow:0 0 0 1px rgba(213,177,92,.12),0 0 18px rgba(213,177,92,.12)!important}
    .draft-status .draft-chip,.pick-card,.board-cell,.board-cell.empty,.draft-board .board-cell.QB,.draft-board .board-cell.RB,.draft-board .board-cell.WR,.draft-board .board-cell.TE,.draft-board .board-cell.DST,.draft-board .board-cell.K{background:#0d161d!important;border-color:var(--shiva-border)!important}
    .draft-board .board-cell.mine{box-shadow:inset 0 0 0 1px rgba(216,180,93,.30)!important}.draft-board .board-cell.clock,.on-clock{background:linear-gradient(145deg,rgba(213,177,92,.24),rgba(213,177,92,.10))!important;border-color:rgba(240,216,143,.72)!important;color:#fff!important;box-shadow:0 0 0 1px rgba(213,177,92,.12),0 0 18px rgba(213,177,92,.12)!important}.board-cell.clock .board-pick,.clock-sub{color:var(--shiva-gold)!important}
    .shiva-iq-panel,.iq-report-shell,.iq-rec{background:#0d161d!important;border-color:var(--shiva-border)!important}.iq-label,.shiva-iq-live{color:var(--shiva-gold)!important}.iq-draft{background:linear-gradient(145deg,rgba(213,177,92,.24),rgba(213,177,92,.10))!important;border:1px solid rgba(240,216,143,.72)!important;color:#fff!important}
