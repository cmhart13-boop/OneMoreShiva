...
def render_dashboard():
    ...
    if state:st.markdown("<div class='league-live'>● ESPN LEAGUE CONNECTED</div>",unsafe_allow_html=True)
...
def render_full_product(players,load_weekly,weekly_for_player,espn_ppr,weekly_name_col):
    ...
    tab=st.radio("Shiva Coach",["Home","Start/Sit","Waivers","Trades","Lineup","Watch","Analysts","League"],horizontal=True,label_visibility="collapsed",key="full_product_tab")
    st.markdown('</div>',unsafe_allow_html=True)
    if tab=="Home":render_dashboard()
